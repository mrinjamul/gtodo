# Contributing to gtodo

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to gtodo, which are hosted in the [mrinjamul/gtodo](https://github.com/mrinjamul/gtodo) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
